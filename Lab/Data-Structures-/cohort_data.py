...
def all_students_tuple_list(filename):
    ...
    for line in house_file:
        ...
        if cohort == "G" or cohort == "I":
            ...
            student_info = (full_name, student_house, advisor, cohort)
...
def find_cohort_by_student_name(student_list):
    ...
    select_student = raw_input("Who are you looking for?")
    # print student_list
    for student_name in student_list:
        if student_name[0] == select_student:
            return "{} was in the {} cohort".format(student_name[0],student_name[3])
        else:
